...
protoc -I proto \
  ...
  proto/student_state.proto proto/node_schema.proto proto/interactive_node.proto \
  proto/knowledge.proto proto/router_api.proto proto/events.proto proto/harness_eval.proto
