...
3. **Persistencia de `ProfileStore`** — ✅ PR 3.1: `ProfileRepository` + `FileProfileStore` (snapshot JSON via `AVLP_PROFILE_STORE_PATH`). SQLite/pg quedan para multi-instancia.
