# Spec: Empty Context Voice

## Purpose

Cuando el miss path no recupera chunks RAG, la estación en vivo habla al
estudiante sin filtrar plantillas ni vocabulario técnico del sistema.
